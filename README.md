...
<div>
    ...
    <p>
      <strong>➡ Antidetect Browser Manager</strong> - new antidetect web browser manager based on selenium with magiceden.io Auto-Mint, Browser scripts builder (ZennoPoster light version) and Telegram auto log-in. <br>
